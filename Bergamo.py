    ...
    with open('./datiElaborati/newBergamo.csv', 'w', newline="",encoding ="UTF-8") as newBergamo: #Creo il nuovo csv in modalità scrittura
        ...
        for riga in dati:
            if '2017' in riga[1]:
                ...
                writer.writerow(["Bergamo", riga[2] , riga[3] , riga[4] , coord[0] , coord[1],  riga[6] , riga[7] , riga[8], riga[9],riga[5]])    #Copiamo nel nuovo csv solo le colonne che ci servono, coord 0 e coord 1 sono le coordinate prese singolarmente